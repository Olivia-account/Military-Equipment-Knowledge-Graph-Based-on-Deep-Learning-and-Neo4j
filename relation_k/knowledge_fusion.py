...
def cluster(input_file,output_file):
    ...
    settings_file = r'F:\graduate_design\code\knowledge_label\resource_all_settings.json'
    training_file = r'F:\graduate_design\code\knowledge_label\resource_all_training.json'
...
def knowledge_fusion(input_path, final_path):
    # input_path = './datam/duie.json'
    ...
    for para in ALL_DATA:
        ...
        if id >1:
            ...
            #print("完成聚类分析")
            clusters = {}
            with open("cluster_in_para.csv", "r", encoding='utf-8') as csvfile:
    ...
    with codecs.open(final_path, 'w', 'utf-8') as f:
        ...
        f.write(ALL_DATA)
        f.write('\n')
    with codecs.open(r'F:\graduate_design\code\relation_k\output\id2para.json', 'w', 'utf-8') as f:
        PARA_DICT = json.dumps(para_dict, ensure_ascii=False)
        f.write(PARA_DICT)
        f.write('\n')

# knowledge_fusion('C:/Users/zhour/PycharmProjects/PD_env/relation_extraction/datam/duie.json', 'C:/Users/zhour/PycharmProjects/PD_env/relation_extraction/output/result.json')
# f=open('C:/Users/zhour/PycharmProjects/PD_env/relation_extraction/datam/duie.json','r',encoding='utf-8')
# for data in f:
...
# print('=============================================')
# with open('C:/Users/zhour/PycharmProjects/PD_env/relation_extraction/output/result.json','r',encoding='utf8')as fp:
