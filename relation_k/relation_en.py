...
from relation_extraction.data_loader import DuIEDataset, DataCollator
from relation_extraction.utils import decoding, find_entity, get_precision_recall_f1, write_prediction_results
...
parser.add_argument("--init_checkpoint", default='./relation_extraction/checkpoints/model_40000.pdparams', type=str, required=False,
                    help="Path to initialize params from")
parser.add_argument("--data_path", default="C:/Users/zhour/PycharmProjects/PD_env/scene_cls/data/", type=str, required=False, help="Path to data.")
parser.add_argument("--predict_data_file", default="./relation_extraction/datam/test_label.json", type=str, required=False,
                    help="Path to data.")
...
def do_train():
    ...
    model = AutoModelForSequenceClassification.from_pretrained('ernie-2.0-base-en', num_classes=seq_num_classes)  # 预训练模型要改
    model = paddle.DataParallel(model)
    # tokenizer = ErnieTokenizer.from_pretrained("ernie-1.0")
    tokenizer = AutoTokenizer.from_pretrained('ernie-2.0-base-en')
