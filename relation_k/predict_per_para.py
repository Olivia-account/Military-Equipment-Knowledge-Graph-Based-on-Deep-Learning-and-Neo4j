...
parser.add_argument("--init_checkpoint", default=r'F:\graduate_design\code\relation_k\checkpoints\model_67000.pdparams',
                    type=str, required=False,
                    help="Path to initialize params from")
parser.add_argument("--data_path", default="F:/graduate_design/code/relation_k/datam/", type=str, required=False,
                    help="Path to data.")
parser.add_argument("--predict_data_file", default=r"F:\graduate_design\code\relation_k\datam\test_label.json",
                    type=str, required=False,
                    help="Path to data.")
parser.add_argument("--output_dir", default="./relation_extraction/checkpoints", type=str, required=False,
...
def evaluate(model, criterion, criterion_seq, data_loader, file_path, mode):
    ...
    # print('1')
    if mode == "predict":
        predict_file_path = r'F:\graduate_design\code\relation_k\datam\duie.json'  # os.path.join(args.data_path, 'duie.json')
    else:
...
# def autogg():
#     print("Processing on input txt...")
#     input_txt = r'F:\graduate_design\code\relation_k\datam\input.txt'  # 输入txt文件路径
#     output_json = r'F:\graduate_design\code\relation_k\datam\test_label.json'
#     para_id = 0
#     flag = 0
#
#     with codecs.open(output_json, 'w', 'utf-8') as jsonf:
...
#         print("Done...Start relation extraction")
#         flag = do_predict()
#
#     if flag:
#         print("Done...Start knowledge fusion")
#         # from knowledge_fusion import *
#         label_file = r'F:\graduate_design\code\relation_k\datam\duie.json'
#         result_file = r'F:\graduate_design\code\relation_k\output\result.json'
#         knowledge_fusion(label_file, result_file)
#         print("Done... Please check result in result.json & id2para.json")
...
#
#     else:
#         print("Errors happen in relation extration")
# autogg()
